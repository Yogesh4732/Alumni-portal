                    ...
                    while ($user = $allUsers->fetch_assoc()) {
                        ...
                        echo '
                            <div class="col-auto mb-3 slide-left">
                                <form action="'.htmlspecialchars('profile_detail.php').'" method="GET" class="position-relative">
                                        ...
                                        <div class="row align-items-center ps-2 py-2">
                                            ...
                                            <div class="col">
                                                <div class="card-body px-2">
                                                    '.$listDetails.'
                                                    <a href="chat_interface.php?receiver_email='.$user['email'].'" class="btn btn-chat btn-sm"><i class="bi bi-chat-dots"></i> Chat</a>
                                                </div>
                                            </div>
                                        </div>
