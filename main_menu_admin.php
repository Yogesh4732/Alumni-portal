...
<body class="admin-bg">
    ...
    <div class="container slide-left">
        <div class="row justify-content-center">
            ...
            <div class="col-auto mb-5">
                <div class="card text-center">
                    <img src="images/day_of_service.PNG" class="card-img-top" alt="Job Photo">
                    <div class="card-body">
                        <h5 class="card-title">Jobs</h5>
                        <p class="card-text">Manage exclusive job listings, workshops, seminars to nurture others' professional growth</p>
                    </div>
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="manage_advertisements.php">Manage Jobs</a> </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-5">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Manage Scholarship</p>
                    </div>
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="manage_scholarships.php">Manage Scholarship</a> </div>
                </div>
            </div>
        </div>
