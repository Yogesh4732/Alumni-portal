...
// Redirects user to the page they tried to visit, if none, main_menu.php (for users) or main_menu_student.php (for students) or main_menu_admin.php (for admins)
// Redirect based on user type
if (isset($_SESSION['logged_account'])) {
    $userType = $_SESSION['logged_account']['type'];
    ...
    if ($userType == 'user') {
        ...
        header('Location: main_menu_student.php');
        exit();
    } else {
