        ...
        <div class="row justify-content-center">
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_advertisements.php">View Jobs</a> </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="images/donation.jpg" class="card-img-top" alt="Donation Photo">
                    <div class="card-body">
                        <h5 class="card-title">Give Back to Your Alma Mater</h5>
                        <p class="card-text">As an alumnus, your contribution can help support current students, fund alumni events, and strengthen the college community. Every donation makes a difference!</p>
                    </div>
                    <div class="d-grid gap-2"> 
                        <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="donation.php">Donate Now</a> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Keep an eye out below for our evolving list of Scholarship</p>
                    </div>
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="view_scholarships.php">Scholarship</a> </div>
                </div>
            </div>
