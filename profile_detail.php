...
<body>
    <?php
        ...
        // Initialize $loggedAccountEmail with the logged-in user's email
    $loggedAccountEmail = isset($_SESSION['logged_account']['email']) ? $_SESSION['logged_account']['email'] : null;
    ?>
        ...
        <div class="container py-4 px-4 mainView bg-white <?php echo (!isset($_GET["search"])) ? 'slide-left' : ''; ?>">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <!-- Chat Button -->
                    <?php if (isset($alumnusToViewEmail) && $alumnusToViewEmail != $loggedAccountEmail): ?>
                    <form class="col-auto">
                    <a href="chat_interface.php?receiver_email=<?php echo urlencode($alumnusToViewEmail); ?>" class="btn bi-chat-fill btn-gray fw-medium px-3">Chat</a>
                    </form>
                    <?php endif; ?>
</div>
